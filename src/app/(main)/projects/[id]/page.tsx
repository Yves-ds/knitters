        ...
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[393px] bg-white z-20">
          <div className="border-t border-[#F0F0F0] flex items-center px-5" style={{ height: 80, gap: 16 }}>
            ...
            <button
              ...
              className="flex items-center gap-[8px] active:opacity-50 shrink-0"
            >
              ...
              <span className="text-[15px] font-normal whitespace-nowrap" style={{ color: hasVideos ? '#F72E00' : '#646464' }}>영상</span>
            </button>
            ...
            >
              ...
              <span className="text-[15px] font-normal whitespace-nowrap" style={{ color: hasPdf ? '#F72E00' : '#646464' }}>도안</span>
            </button>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-[15px] font-normal whitespace-nowrap" style={{ color: project.isShared ? '#F72E00' : '#646464' }}>공유</span>
              </button>
            </div>
